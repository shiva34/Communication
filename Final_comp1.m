%Here we just show the implementation for any user input signal and we
%don't add noise in this one.

%First of all we clear all existing data.
clc;  %clear command window
close all;  %closes all other workable windows
clear all; %Clears all workspace
...
recieved=modulated; %We don't add noise here
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
